...
import { InputState, CustomPaper } from '../types';

interface OffsetPaperSelectionProps {
...
export const OffsetPaperSelection: React.FC<OffsetPaperSelectionProps> = ({
  isCustomPaper,
  setIsCustomPaper,
  inputs,
  setInputs,
        ...
        <div className="flex bg-white rounded border overflow-hidden">
          <button
            ...
            className={`px-2 py-1 text-[10px] font-bold ${
              !isCustomPaper ? 'bg-indigo-100 text-indigo-700' : 'text-slate-500'
            }`}
          >
            Chuẩn
          </button>

...
import { Scissors, X, AlertTriangle, Play, Pause, SkipBack, SkipForward } from 'lucide-react';
    ...
    <div className="fixed inset-0 bg-black/50 z-[60] flex items-center justify-center p-4">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg overflow-hidden">
        ...
        <div className="bg-slate-100 p-6 flex flex-col items-center min-h-[300px]">
          ...
          <div
            className="relative bg-white shadow-sm border border-slate-300 w-full max-w-[280px]"
        ...
        <div className="p-4 border-t bg-white flex justify-between items-center">
          <div className="flex gap-2">
            ...
            <button
              ...
              className="p-2 rounded bg-cyan-600 text-white hover:bg-cyan-700 w-10 flex justify-center cursor-pointer"
            >

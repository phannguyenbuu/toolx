...
import { ConfigState, InputState } from '../../../utils/calculatorTypes';

interface DigitalGeneralConfigProps {
  config: ConfigState;
  setConfig: (config: ConfigState) => void;
  inputs: InputState;
}

export const DigitalGeneralConfig: React.FC<DigitalGeneralConfigProps> = ({
  config,
  setConfig,
  inputs
}) => {
    ...
    <div className="bg-white rounded-xl shadow-sm border overflow-hidden">
      <div className="p-4 border-b bg-gradient-to-r from-slate-50 to-slate-100">
        <h2 className="font-bold text-slate-800 flex items-center gap-2">
          <Settings size={18} className="text-cyan-600" /> Cấu Hình Chung
        </h2>
      </div>
          ...
          <div className="bg-slate-50 p-2 rounded border">
            ...
            <div className="flex items-center gap-1">
              <input
                ...
                className="w-full p-1.5 text-sm border rounded font-mono font-bold text-slate-700 bg-white"
              />
              ...
              <div key={finishing.type} className="bg-white p-3 rounded-md border border-green-100">
                ...
                <div className="flex items-center gap-1">
                  <input
                    ...
                    className="w-full p-2 border rounded font-mono font-bold text-slate-700 text-sm bg-white"
                    placeholder="0"
                  />

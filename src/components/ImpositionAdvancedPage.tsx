...
export const ImpositionAdvancedPage: React.FC<ImpositionAdvancedPageProps> = ({ onClose }) => {
  ...
  const actionsHook = useImpositionActions({
    ...
    setIsAiModalOpen, setIsFilePickerOpen, setIsSourceEditorOpen: setIsCropColorModalOpen,
  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden bg-slate-100 text-slate-800">
      ...
      <ImpositionPageModals
        ...
        setIsRenderModalOpen={setIsRenderModalOpen}
        isSubmittingRender={actionsHook.isGenerating}
        ...
        currentPlan={currentPlan}
        renderProgressText={actionsHook.renderStatusText}
        isGenerating={actionsHook.isGenerating}
        progress={actionsHook.progress}
        renderStatusText={actionsHook.renderStatusText}
